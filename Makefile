...
test01: default
	...
	./ch347eeprom -v -s 24c01 -w tmp_random.bin
	./ch347eeprom -v -s 24c01 -r tmp_random_readed.bin
...
test02: default
	...
	./ch347eeprom -v -s 24c02 -w tmp_random.bin
	./ch347eeprom -v -s 24c02 -r tmp_random_readed.bin
	cmp tmp_random.bin tmp_random_readed.bin
	rm -f tmp_random.bin tmp_random_readed.bin
...
test04: default
	...
	./ch347eeprom -v -s 24c04 -w tmp_random.bin
	./ch347eeprom -v -s 24c04 -r tmp_random_readed.bin
	cmp tmp_random.bin tmp_random_readed.bin
	rm -f tmp_random.bin tmp_random_readed.bin
...
test08: default
	...
	./ch347eeprom -v -s 24c08 -w tmp_random.bin
	./ch347eeprom -v -s 24c08 -r tmp_random_readed.bin
	cmp tmp_random.bin tmp_random_readed.bin
	rm -f tmp_random.bin tmp_random_readed.bin
...
test16: default
	...
	./ch347eeprom -v -s 24c16 -w tmp_random.bin
	./ch347eeprom -v -s 24c16 -r tmp_random_readed.bin
	cmp tmp_random.bin tmp_random_readed.bin
	rm -f tmp_random.bin tmp_random_readed.bin
...
test32: default
	...
	./ch347eeprom -v -s 24c32 -w tmp_random.bin
	./ch347eeprom -v -s 24c32 -r tmp_random_readed.bin
	cmp tmp_random.bin tmp_random_readed.bin
	rm -f tmp_random.bin tmp_random_readed.bin
...
test64: default
	...
	./ch347eeprom -v -s 24c64 -w tmp_random.bin
	./ch347eeprom -v -s 24c64 -r tmp_random_readed.bin
	cmp tmp_random.bin tmp_random_readed.bin
	rm -f tmp_random.bin tmp_random_readed.bin
...
test128: default
	...
	./ch347eeprom -v -s 24c128 -w tmp_random.bin
	./ch347eeprom -v -s 24c128 -r tmp_random_readed.bin
	cmp tmp_random.bin tmp_random_readed.bin
	rm -f tmp_random.bin tmp_random_readed.bin
...
test256: default
	...
	./ch347eeprom -v -s 24c256 -w tmp_random.bin
	./ch347eeprom -v -s 24c256 -r tmp_random_readed.bin
	cmp tmp_random.bin tmp_random_readed.bin
	rm -f tmp_random.bin tmp_random_readed.bin
...
test512: default
	...
	./ch347eeprom -v -s 24c512 -w tmp_random.bin
	./ch347eeprom -v -s 24c512 -r tmp_random_readed.bin
	cmp tmp_random.bin tmp_random_readed.bin
	rm -f tmp_random.bin tmp_random_readed.bin
...
test1024: default
	...
	./ch347eeprom -v -s 24c1024 -w tmp_random.bin
	./ch347eeprom -v -s 24c1024 -r tmp_random_readed.bin
	cmp tmp_random.bin tmp_random_readed.bin
	rm -f tmp_random.bin tmp_random_readed.bin
